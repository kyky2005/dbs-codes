...
$borrower_create_status = null;
$borrower_create_message = '';
...
if (isset($_POST['add_browser'])) {
  ...
  try {
    ...
    $borrower_id = $con->insertBorrower($firstname, $lastname, $email, $phone, $borrower_member_since, $is_active);
    $borrower_user_id = $con->insertBorrowerUser($user_id, $borrower_id);
                ...
                <tr>
                  ...
                  <td class="text-end">
                    <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                      data-bs-target="#resetPassModal">Reset Password</button>
          ...
          <div class="col-12 col-lg-6">
            <div class="card p-4 h-100">
              ...
              <form action="#" method="POST">
                ...
                <button name="add_browser" class="btn btn-primary w-100 mt-3" type="submit">Create Borrower
                  Account</button>
              </form>
            </div>
          </div>
...
const createStatus = <?php echo json_encode($borrower_create_status) ?>;
const createMessage = <?php echo json_encode($borrower_create_message) ?>;
