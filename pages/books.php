...
if (isset($_POST['update_book'])) {
  ...
  try {
    ...
    $book_create_status = 'success';
    $book_create_message = 'Book Updated Successfully';
  } catch (PDOException $e) {
    throw $e;
    $book_create_status = 'unsuccessful';
    $book_create_message = $e->getMessage();
...
if (isset($_POST['add_bookauthor'])) {
  try {
    ...
    $book_create_status = 'success';
    $book_create_message = 'Author assigned to book successfully';
  } catch (PDOException $e) {
    throw $e;
    $book_create_status = 'unsuccessful';
    $book_create_message = $e->getMessage();
...
if (isset($_POST['add_bookgenre'])) {
  try {
    ...
    $book_create_status = 'success';
    $book_create_message = 'Genre assigned to book successfully';
  } catch (PDOException $e) {
    throw $e;
    $book_create_status = 'unsuccessful';
    $book_create_message = $e->getMessage();
          ...
          <div class="table-responsive">
            <table class="table table-sm align-middle">
              ...
              <tbody>
                ...
                $allbooks = $con->viewbookcopy();
                foreach ($allbooks as $books) {
                  echo '<tr>';
                  echo '<td>' . $books['book_id'] . '</td>';
                  echo '<td>' . $books['book_title'] . '</td>';
                  echo '<td>' . $books['book_isbn'] . '</td>';
                  echo '<td>' . $books['book_publication'] . '</td>';
                  echo '<td>' . $books['book_publisher'] . '</td>';
                  echo '<td>' . $books['copy_count'] . '</td>';
                  echo '<td class="text-center"><span class="badge text-bg-success">' . $books['available_copies'] . '</span></td>';
              ...
              data-book-title="' . htmlspecialchars($books['book_title'], ENT_QUOTES) . '"
              data-book-isbn="' . htmlspecialchars($books['book_isbn'], ENT_QUOTES) . '"
              data-book-publication="' . $books['book_publication'] . '"
              data-book-publisher="' . htmlspecialchars($books['book_publisher'], ENT_QUOTES) . '"
          ...
          <div class="row g-3">
            <div class="col-12 col-lg-6">
              <div class="border rounded p-3">
                ...
                <form action="books.php" method="POST" class="row g-2">
                  ...
                  <div class="col-12">
                    <button name="add_bookauthor" class="btn btn-outline-primary w-100" type="submit">Assign</button>
                  </div>
                </form>
            ...
            <div class="col-12 col-lg-6">
              <div class="border rounded p-3">
                ...
                <p class="small-muted mb-3">Creates a row in <>BookGenre</ b>.</p>
                ...
                <form action="books.php" method="POST" class="row g-2">
                  ...
                  <div class="col-12">
                    <button name="add_bookgenre" class="btn btn-outline-primary w-100" type="submit">Assign</button>
                  </div>
                </form>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="books.php" method="POST">
            ...
            <div class="mb-3">
              <label class="form-label">Title</label>
              <input class="form-control" name="book_title" id="editBookTitle" required>
            </div>
            <div class="mb-3">
              <label class="form-label">ISBN</label>
              <input class="form-control" name="book_isbn" id="editBookIsbn" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Publication Year</label>
              <input class="form-control" name="book_publication_year" id="editBookPublication" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Publisher</label>
              <input class="form-control" name="book_publisher" id="editBookPublisher" required>
            </div>
...
<script>
  ...
  editModal.addEventListener('show.bs.modal', function(event) {
    ...
    document.getElementById('editBookTitle').value = btn.getAttribute('data-book-title') || '';
    document.getElementById('editBookIsbn').value = btn.getAttribute('data-book-isbn') || '';
    document.getElementById('editBookPublication').value = btn.getAttribute('data-book-publication') || '';
    document.getElementById('editBookPublisher').value = btn.getAttribute('data-book-publisher') || '';
  });
</script>
